...
---
[**icestark**](https://micro-frontends.ice.work/)（飞冰 **微前端体系**）与 **ice.js**（飞冰中后台框架）、**微模块** 等同站维护。主应用、子应用、**权限与布局** 的写法以 [官方文档](https://micro-frontends.ice.work/) 与当前 `@ice/*` 包版本为准。本篇给出 **可开工的顺序** 与 **常见落地点**，具体 **API/包名** 从文档与脚手架生成物核对。

***

### 一、何时走 icestark

* 已选或计划选 ==**ice.js 3**（飞冰应用框架，内置路由与工程约定）== 作 **中后台** 主技术栈。

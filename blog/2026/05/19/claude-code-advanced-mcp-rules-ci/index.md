...
---
[《Claude Code 从 0 到 1》](/2026/05/21/claude-code-zero-to-one-tutorial/)解决「能用」；进阶要解决 **和团队仓库、外部系统、CI 怎么闭环**。本篇串 **MCP 接事实源 → Rules 定边界 → CI 当验收闸** 的完整流水线。
...
`.cursor/mcp.json` 或 Claude Code 对应配置（路径以产品文档为准）：

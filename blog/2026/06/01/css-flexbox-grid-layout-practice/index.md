...
---
Tailwind 与 Design Token 文（[选型](/2023/05/23/css-tailwind-modules-scoped-selection/)、[主题](/2026/05/24/design-token-theme-dark-mode-practice/)）解决 **怎么写样式**；这篇补 **Flex**（一维弹性布局）/ **Grid**（二维网格布局） 因果——中后台卡片、表单、仪表盘、圣杯布局该用谁。
...
| 场景 | 更推荐 | 原因 |
|------|--------|------|
| 导航栏、工具条、按钮组 | **Flex** | 一维（主轴方向）、内容驱动宽度 |
| 表单行内 label + input | **Flex** | 对齐轴清晰 |
| 整页 dashboard 分栏 | **Grid** | 二维区域命名 |
| 照片墙、固定列数卡片 | **Grid** | `repeat(auto-fill, minmax())`（自适应列数网格）（自适应列数网格） |

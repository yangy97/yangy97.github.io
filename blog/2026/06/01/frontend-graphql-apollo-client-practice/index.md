...
---
REST 之外，中台与 BFF 层 increasingly 暴露 **GraphQL**。本站已有 [Protobuf RPC 客户端栈](/2023/08/15/bff-protobuf-rpc-client-stack-srpc-pattern/)，本篇补 **前端怎么接、和 REST 怎么选、缓存怎么踩坑**——以 Apollo Client + Vue/React 为例，概念可迁移到 urql / TanStack Query。

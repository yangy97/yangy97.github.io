...
```js
let xhr = new XMLHttpRequest(); // 传统 AJAX（Asynchronous JavaScript And XML/JSON）（异步 HTTP 请求）对象 // 传统 AJAX（Asynchronous JavaScript And XML/JSON）（异步 HTTP 请求）对象 // 传统 AJAX（异步 HTTP 请求）对象 

...
#### \*\*\*\***requestAnimationFrame**（与刷新率同步的动画帧）**（与刷新率同步的动画帧）**（与刷新率同步的动画帧）
...
> 想学习可以系统性看 [MDN \*\*\*\***Canvas**（位图画布 2D/WebGL）**（位图画布 2D/WebGL）**（位图画布 2D/WebGL）](https://developer.mozilla.org/zh-CN/docs/Web/API/Canvas_API)
